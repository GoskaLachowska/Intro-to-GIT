...
* Describe those tasks in the form of a computer program.xzxxxxx

* Execute the program.

The dplyr package makes these steps fast and easy:
onstraining your options, it helps you think about your data manipulation 
  challenges.
